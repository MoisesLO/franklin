                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text('Mision del Consultorio', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                    ),
                    Padding(
                    ...
                    Padding(
                      padding: const EdgeInsets.only(left: 15, top: 25),
                      child: Text('Vision del Consultorio', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(top: 15, left: 15),
                      child: Text(
